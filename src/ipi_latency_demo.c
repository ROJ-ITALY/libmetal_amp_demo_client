...
//
//	//Read Clock Control Register TTC0_ID_3
//	unsigned long offset;
//	uint64_t value;
//	offset = XTTCPS_CLK_CNTRL_OFFSET + XTTCPS_CNT_OFFSET(TTC_CNT_RPU_TO_APU);
//	value = metal_io_read32(ch->ttc_io, offset);
//	LPRINTF("***Clock Control Register ID 3: %lu\n",value);
//}
